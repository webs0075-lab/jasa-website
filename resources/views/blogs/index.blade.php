...
<head>
    ...
    <title>Blog - Jasa Web & Android</title>
    ...
    <section class="py-24 px-6 bg-linear-to-br from-blue-50 to-indigo-100">
        <div class="container mx-auto max-w-6xl text-center">
            ...
            <p class="text-xl text-slate-600 max-w-3xl mx-auto">
                Berbagi pengetahuan dan tips seputar pengembangan web, aplikasi, dan teknologi digital
            </p>
        </div>
    </section>
            ...
            <div class="grid md:grid-cols-2 lg:grid-cols-3 gap-8">
                ...
                <article class="bg-white rounded-2xl overflow-hidden shadow-lg hover:shadow-xl transition-shadow duration-300">
                    ...
                    <div class="p-6">
                        ...
                        <h3 class="text-xl font-bold text-slate-900 mb-2">{{ $blog->title }}</h3>
                        <p class="text-slate-600 mb-4 line-clamp-3">{{ $blog->excerpt ?? Str::limit(strip_tags($blog->content), 150) }}</p>
                        <a href="{{ route('blogs.show', $blog->slug) }}" class="inline-flex items-center text-blue-600 font-medium hover:text-blue-700 transition-colors">
                            Baca Selengkapnya
                ...
                <div class="col-span-full text-center py-12">
                    <i data-lucide="file-x" class="w-16 h-16 text-slate-400 mx-auto mb-4"></i>
                    <h3 class="text-xl font-semibold text-slate-600 mb-2">Belum ada artikel</h3>
                    <p class="text-slate-500">Artikel blog akan segera ditambahkan.</p>
                </div>
                @endforelse
            </div>
